...
public class ProdutoController {
	 ...
	 @Autowired
	    ...
	    public ResponseEntity<Produto> updateProduto(@PathVariable Long id, @RequestBody Produto produtoDetails) {
	        // (Assumindo que seu ProdutoService tem um método 'saveProduto')
	        
	        produtoDetails.setIdProduto(id); // Garante o ID
	        
	        Produto produtoAtualizado = produtoService.salvarProduto(produtoDetails);
